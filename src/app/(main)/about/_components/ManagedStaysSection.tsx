...
export default function ManagedStaysSection() {
  return (
    <section className="bg-[#F7F2EA] py-8 md:py-[5%]">
      <Container>
        <Reveal>
          <h2 className="font-playfair italic font-normal text-[#16323C] text-center mb-6 md:mb-16" style={{ fontSize: "clamp(2rem, 4vw, 3rem)" }}>
            Managed Stays
          </h2>
        </Reveal>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 items-start">
          ...
          <Reveal delay={0.12}>
            <div className="bg-white rounded-2xl p-6 md:p-8 md:mt-20">
              <div className="text-[#C07A5A] mb-6">
                <svg width="30" height="30" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
